...
import BristolCorners from "../../soldbycermak/Farmington Hills 2/Bristol Corners/Bristol Corners -10 20 14.pdf";
...
import Oakland from "../../soldbycermak/Farmington Hills 2/Master Deed and Bylaws OCR/Master Deed and By-Laws-OCR.pdf";
...
import Woodcreek from "../../soldbycermak/Farmington Hills 2/Woodcreek Rules and Regulation/WOODCREEK RULES AND REGULATION2018-2019.docx";
...
export default function FarmingtonHills () {
    ...
    return(
        <div>
            <a style={{color: 'black', display: 'flex', margin: '2%'}}href={BristolCorners}>Bristol Corners</a>
            ...
            <a style={{color: 'black', display: 'flex', margin: '2%'}}href={Oakland}>Oakland County Condominium Master Deed and Bylaws</a>
            ...
            <a style={{color: 'black', display: 'flex', margin: '2%'}}href={Woodcreek}>Woodcreek Rules and Regulations</a>
